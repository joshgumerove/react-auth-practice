...
const AuthForm = () => {
  ...
  const submitHandler = (e) => {
    ...
    if (isLogin) {
      url =
        "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzdsaSyBZhlNasdfdsafadsf2uMggCYzxEKBlPQyX--E1NfsdfdsfmcHlk";
      ...
      fetch(url, {
        ...
        .catch((err) => {
          alert(err.message);
        }); //catching error from else block
    } else {
      url =
